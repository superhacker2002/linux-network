...
##### Настроить конфигурации машин в  _etc/netplan/00-installer-config.yaml_  для

###### ws11:
![Добавление статических ip и маршрута в ws11](screenshots/network_ip_ws11.png)

###### ws21:
![Добавление статических ip и маршрута в ws21](screenshots/network_ip_ws21.png)

###### ws22:
![Добавление статических ip и маршрута в ws22](screenshots/network_ip_ws22.png)

Для роутеров добавляем дополнительные сетевые адаптеры, чтобы мы могли использовать интерфейс eth1 (у нас enp0s8)

###### r1:
![Добавление статических ip и маршрута в r1](screenshots/network_ip_r1.png)

###### r2:
![Добавление статических ip и маршрута в r2](screenshots/network_ip_r2.png)
...
###### ws11:
![Настройка шлюза по умолчанию для ws11](screenshots/default_gw_ws11.png)

###### ws21:
![Настройка шлюза по умолчанию для ws21](screenshots/default_gw_ws21.png)

###### ws22:
![Настройка шлюза по умолчанию для ws22](screenshots/default_gw_ws22.png)

##### Вызвать `ip r` и показать, что добавился маршрут в таблицу маршрутизации

###### ws11:
![Проверка маршрута по умолчанию на ws11](screenshots/check_default_gw_ws11.png)

###### ws21:
![Проверка маршрута по умолчанию на ws21](screenshots/check_default_gw_ws21.png)

###### ws22:
![Проверка маршрута по умолчанию на ws22](screenshots/check_default_gw_ws22.png)

##### Пропинговать с ws11 роутер r2 и показать на r2, что пинг доходит. Для этого использовать команду: `tcpdump -tn -i eth1`
###### Для этого на ws11 делаем ping 10.100.0.12, и на r2 в выводе tcpdump видим, что приходят echo request c 10.10.0.2 (адреса ws11)
![Ping r2 с ws11](screenshots/ping_r2_from_ws11.png)
...
###### r1:
![Добавление статического маршрута на r1](screenshots/static_route_r1.png)

###### r2:
![Добавление статического маршрута на r2](screenshots/static_route_r2.png)

##### Вызвать `ip r` и показать таблицы с маршрутами на обоих роутерах.

###### r1:
![Проверка статическог маршрута на r1](screenshots/check_route_r1.png)

###### r2:
![Проверка статическог маршрута на r2](screenshots/check_route_r2.png)

Маршрутизатор смотрит, куда идет пакет, находит в таблице маршрутизации наиболее специфичный маршрут до пункта назначения (longest match), и переправляет пакет в тот интерфейс, который был записан в таблице напротив этого самого маршрута. Соответственно, для отправки пакета в подсеть 10.10.0.0 был выбран заданный маршрут. Для 0.0.0.0 совпадения в таблице маршрутизации не были найдены и, соответственно, пакет отправился бы по дефолтному маршруту.
