...
###### ws1:
![Запуск firewall скрипта ws1](screenshots/start_firewall_ws1.png)

###### ws2:
![Запуск firewall скрипта ws2](screenshots/start_firewall_ws2.png)

После запуска скрипта мы видим, что машина ws2 не получает никаких сообщений от ws1 при ping, соответственно, echo reply на ws1 остался заблокирован, хотя последним правилом в ее списке iptables было правило accept. 
