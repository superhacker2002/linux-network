...
После запуска скрипта мы видим, что машина ws2 не получает никаких сообщений от ws1 при ping
...
Из этого можно сделать вывод, что более приоритетным правилом в конфигурации iptables будет первое правило, а противоречащие ему правила учитываться не будут.a
